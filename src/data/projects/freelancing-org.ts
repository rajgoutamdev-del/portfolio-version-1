...
export const FREELANCING_ORG: PersonalProject = {
  ...
  whatItIs:
    'A pipeline that runs the early stages of freelance work end to end — discovering opportunities, researching them, scoring fit, and drafting proposals — so my own time goes into the parts that actually need a human.',
